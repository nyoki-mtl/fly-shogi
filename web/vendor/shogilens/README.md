...
`ui/vendor/shogilens/` contains the React board sources. `Hand`, `Piece`, `Square`, `BoardSvgDecorations`, `BoardStageFrameOverlay`, geometry, hand layout, palette, and frame metrics are copied unchanged. All 28 default `public/pieces/hitomoji/*.png` images are unchanged.
